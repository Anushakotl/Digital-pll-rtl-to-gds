...
assign ki_s          = $signed(ki);
   ...
   assign phase_error_16 = {{8{phase_error_s[7]}}, phase_error_s};

   // =========================================================
// FIXED GAIN PROPORTIONAL PATH
//
// kp uses Q4.4:
// 16 = 1.0
// 8  = 0.5
...
// 24 = 1.5
//
// Instead of a general multiplier, implement each gain
    ...
    case (kp)
        ...
        8'd16:
            proportional_product =
                phase_error_16 <<< 4;          // error * 16

        8'd8:
            proportional_product =
                phase_error_16 <<< 3;          // error * 8

        8'd4:
            proportional_product =
                phase_error_16 <<< 2;          // error * 4

        8'd24:
            proportional_product =
                (phase_error_16 <<< 4)
                + (phase_error_16 <<< 3);      // error * 24

        default:
            proportional_product = 16'sd0;
...
// =========================================================
// FIXED GAIN INTEGRAL PATH
//
// ki:
// 2 = 0.125
// 1 = 0.0625
//
// Since phase_error has no fractional bits and the products
// remain Q4-scaled:
//
// error * 2 -> shift left by 1
// error * 1 -> unchanged
// =========================================================
